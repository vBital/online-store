                        ...
                        <ul class="nav">
							...
							<li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item active" href="menus.php" class="active">Menus</a>
                                    <a class="dropdown-item" href="bebidas.php">Bebidas</a>
                                    <a class="dropdown-item" href="sobremesas.php">Sobremesas</a>
                                </div>
                            </li>
                        ...
                        <ul class="nav">
							...
							<li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="bebidas.php" class="active">Bebidas</a>
                                    <a class="dropdown-item" href="sobremesas.php">Sobremesas</a>
                                </div>
                            </li>
                            <li><a href="checkout.php">Checkout</a></li>
    ...
    <section class="section" id="trainers">
        <div class="container">
			...
			<?php
				...
				$sql = "SELECT * FROM produto WHERE id_categoria = 'MENU'";
				$result = $conn->query($sql);
