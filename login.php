...
<div class="form-group">
	...
	<p class="lead"><span class="text-success">Novo Cliente</span></p>
	<ul class="list-unstyled" style="line-height: 2">Registar uma nova conta de cliente
                     </ul>
	<p><a href="registo.php" class="btn btn-info btn-block" style="width:400px">Registar</a></p>
	<br>
	<br>
</div>
</div>
